                ...
                <form method="post">
                    ...
                    <fieldset>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-lg-auto">
                                <input type="text" class="form-control" id="dogovor_nomer" placeholder="Номер договора"
                                       name="dogovor_nomer">
                            </div>
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-lg-auto">
                                <input type="date" class="form-control" id="dogovor_sana" placeholder="Дата договора"
                                       name="dogovor_sana">
                            </div>
                        </div>
                        ...
                        <div class="form-group">
                            <label for="email" class="col-lg-10 control-label">Электронная почта</label>
                            <div class="col-lg-auto">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-lg-auto">
                                <input type="text" class="form-control" id="add_kvartira" placeholder="Номер квартиры"
                                       name="add_kvartira">
                            </div>
                        </div>
                        <div class="form-group">
